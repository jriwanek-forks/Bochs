...
#include "corei7_haswell_4790K.h"

#define LOG_THIS cpu->

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

corei7_haswell_4790k_t::corei7_haswell_4790k_t(BX_CPU_C *cpu): bx_cpuid_t(cpu)
{
  if (BX_SUPPORT_VMX == 1)
...
void corei7_haswell_4790k_t::get_cpuid_leaf(Bit32u function, Bit32u subfunction, cpuid_function_t *leaf) const
{
  static const char* brand_string = "Intel(R) Core(TM) i7-4790K CPU @ 4.00GHz\0\0\0\0\0\0\0\0";
...
Bit32u corei7_haswell_4790k_t::get_vmx_extensions_bitmask(void) const
{
...
// leaf 0x00000001 //
void corei7_haswell_4790k_t::get_std_cpuid_leaf_1(cpuid_function_t *leaf) const
{
...
// leaf 0x00000002 //
void corei7_haswell_4790k_t::get_std_cpuid_leaf_2(cpuid_function_t *leaf) const
{
...
// leaf 0x00000004 //
void corei7_haswell_4790k_t::get_std_cpuid_leaf_4(Bit32u subfunction, cpuid_function_t *leaf) const
{
...
// leaf 0x00000007 //
void corei7_haswell_4790k_t::get_std_cpuid_leaf_7(Bit32u subfunction, cpuid_function_t *leaf) const
{
  switch(subfunction) {
  case 0:
...
// leaf 0x0000000A //
void corei7_haswell_4790k_t::get_std_cpuid_leaf_A(cpuid_function_t *leaf) const
{
...
// leaf 0x80000001 //
void corei7_haswell_4790k_t::get_ext_cpuid_leaf_1(cpuid_function_t *leaf) const
{
...
void corei7_haswell_4790k_t::dump_cpuid(void) const
{
  bx_cpuid_t::dump_cpuid(max_std_leaf, max_ext_leaf);
}

bx_cpuid_t *create_corei7_haswell_4790k_cpuid(BX_CPU_C *cpu) { return new corei7_haswell_4790k_t(cpu); }
