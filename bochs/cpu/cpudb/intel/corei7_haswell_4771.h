...
#ifndef BX_COREI7_HASWELL_4771_CPUID_DEFINITIONS_H
#define BX_COREI7_HASWELL_4771_CPUID_DEFINITIONS_H

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

#include "cpu/cpuid.h"

class corei7_haswell_4771_t : public bx_cpuid_t {
public:
  corei7_haswell_4771_t(BX_CPU_C *cpu);
  virtual ~corei7_haswell_4771_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "corei7_haswell_4771"; }
...
extern bx_cpuid_t *create_corei7_haswell_4771_cpuid(BX_CPU_C *cpu);
