...
bx_define_cpudb(corei7_sandy_bridge_2700k)
#if BX_SUPPORT_AVX
...
bx_define_cpudb(corei7_haswell_4770k)
bx_define_cpudb(corei7_haswell_4771)
bx_define_cpudb(corei7_haswell_4790)
bx_define_cpudb(corei7_haswell_4790k)
